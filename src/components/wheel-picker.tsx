  ...
  return (
    <WheelPickerPrimitive.WheelPicker
      classNames={{
        ...
        highlightWrapper: cn(
          "bg-transparent text-white dark:bg-transparent dark:text-white",
          "data-rwp-focused:ring-2 data-rwp-focused:ring-[#78b8ff]/40 data-rwp-focused:ring-inset dark:data-rwp-focused:ring-[#78b8ff]/40",
